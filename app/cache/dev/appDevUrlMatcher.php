...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'herman_user_homepage')), array (  '_controller' => 'herman\\UserBundle\\Controller\\DefaultController::indexAction',));
        }

        if (0 === strpos($pathinfo, '/user')) {
            // herman_user_index
            if ($pathinfo === '/user/index') {
                return array (  '_controller' => 'herman\\UserBundle\\Controller\\UserController::indexAction',  '_route' => 'herman_user_index',);
            }
            ...
            if (0 === strpos($pathinfo, '/user/view') && preg_match('#^/user/view/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'herman_user_view')), array (  '_controller' => 'herman\\UserBundle\\Controller\\UserController::viewAction',));
            }
